To test on dev machine:

Start the node app on bin\testauth
...
http://rose.cs.umass.edu/testauth/login or
  http://rose.cs.umass.edu/testauth
...
Take a look at the util/config.js file to verify its contents (make a safe backup)
sudo git pull
Take a look at the util/config.js file to verify its the same
